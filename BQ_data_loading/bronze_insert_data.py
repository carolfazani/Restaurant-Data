...
class BronzeDataPipeline:
    ...
    def insert_item_sales(self):
        ...
        self.bq.load_dataframe_to_bigquery(dataframe=item_sales, dataset_id='bronze', table_name='item_sales', column_types=column_types, load_mode='WRITE_APPEND')
    ...
    def insert_revenue(self):
        ...
        self.bq.load_dataframe_to_bigquery(dataframe=revenue, dataset_id='bronze', table_name='revenue', column_types=revenue_column_types, load_mode='WRITE_APPEND')

        payment_methods_column_types = generate_column_types_bronze(payment_methods)
        self.bq.load_dataframe_to_bigquery(dataframe=payment_methods, dataset_id='bronze', table_name='payment_methods', column_types=payment_methods_column_types, load_mode='WRITE_APPEND')
